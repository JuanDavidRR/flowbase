...
export default function BillingToggle() {
	...
	function handleValueChange(value: string[]) {
		...
		setPeriod(next);
		document.getElementById(PRICING_SECTION_ID)?.setAttribute('data-billing-period', next);
	}
	...
	return (
		<ToggleGroup
			...
			variant="outline"
		>
			<ToggleGroupItem value="monthly" data-event="toggle_billing" data-billing-period="monthly">
				Monthly
			</ToggleGroupItem>
			<ToggleGroupItem value="annual" data-event="toggle_billing" data-billing-period="annual">
				Annual
